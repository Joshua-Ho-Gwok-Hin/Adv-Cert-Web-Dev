...
<head>
	...
	<title>Admin Home - ABC Community Portal</title>
	<style>
...
<h1>Welcome ${firstName} ${lastName}</h1>
		<a href="update-profile?id=${id}" class="btn btn-info">Update Profile</a>		
		<a href="public-profile?id=${id}" class="btn btn-info">View my public profile</a>		
<form modelAttribute="userProfile" method="get" action="admin-search">
